...
<sub>La tarjeta de arriba es un SVG generado con <code>generate_svg.py</code>. Los links clickeables están en los badges. / The card above is an SVG generated by <code>generate_svg.py</code>. Clickable links are in the badges.</sub>
